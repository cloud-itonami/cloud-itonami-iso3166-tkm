(ns marketentry.registry
  ...
  unit fields), reapplied to a market-entry engagement fee line. This
  is jurisdiction-agnostic (this actor's OWN service-fee honesty, not
  a Turkmenistan-specific fact) -- it applies regardless of how thin a
  jurisdiction's own regulatory fact base is.
